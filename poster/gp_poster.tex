...
\begin{frame}{} 
  ...
  \begin{column}{.33\linewidth}
    ...
    \begin{block}{Highlights/Abstract}%{Introduction} %Abstract?  Intro & Conclusions?
            ...
            \item Novel nonparametric procedure for \highlight{fast inference} in \highlight{generative graphical models with large number of latent states}, e.g. $\# latent states^{\# latent variables}$ %exponential in the number of latent variables
  ...
  \begin{column}{.32\linewidth}
    ...
    %   \textcolor{blocktbgn}{Data \& dictionary elemements} 
           ...
           \begin{itemize}
            ...
            \item \highlight{Shown}: GP-select \highlight{converges to GT params}, $W_{GP-select}$ % as w. hand-crafted sel functions ($W_{hand-craft}$) .
...
to reconstruct strongly corrupted scanned texts. IEEE Transactions on Pattern Analysis and Machine Intelligence, 36(10):1950–1962.\
...
%[5] Sameer Singh, Michael L. Wick, and Andrew McCallum. Monte carlo mcmc: Efficient inference by approximate sampling. In EMNLP-CoNLL, pages 1104–1113. ACL, 2012.
    ...
    \vspace{-.7cm}
      \begin{column}{.45\linewidth}
        ...
        \scriptsize
        \lbrack3\rbrack \ Another ref.\\
        \lbrack4\rbrack \ One more!
      \end{column}
    \end{columns}
    }
%
