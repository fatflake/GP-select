...
binary latent variables\footnote{We restrict ourselves binary latent variables here, though
...
and the distribution over the data with the likelihood $p(\vec{y} | \vec{s}, \theta)$
...
\dots, N \}$.  
% FIXME TODO incorporate feedback from review! unclear here
