...
Our approach is the first to make ET a general purpose algorithm% using GPs to approximate intractable computations
...
Note that although we restrict ourselves to binary latent variables here, discrete variables with higher cardinality can easily be used by converting them into binary valued vectors of the requisite length.
