...
%
%define f--
%introduce new function, call it f takes data point $y^(n)$, produces ability, jointly oredicts probability of all latents being 1
...
iterations. 
%
% XXX AND WHY WAS THIS REMOVED???? -JS
