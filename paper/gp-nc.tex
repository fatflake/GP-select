...
{$^{\displaystyle 1}$TU Berlin.}\\
{$^{\displaystyle 2}$UCL Gatsby.}\\
{$^{\displaystyle 3}$Amazon.}\\
{$^{\displaystyle 4}$University of Sheffield.}\\
{$^{\displaystyle 5}$University of Oldenburg.}\\
%
%Berlin, Germany \\
...
%\ \\[-2mm]
{\bf Keywords:} Approximate inference, generative graphical models, latent variable models, Expectation Maximization
